...
[./constants]
  ...
  prop_values = '1.5    1.5     1.5     13.8  1e6   1e-4      0.5       1      3.2     3.2     3.2    10                   10                    1e4           1e4                  1e4                  1e4'
[../]
[./m]
  type = ParsedMaterial
  f_name = mu
...
[./L]
  ...
  function = 'if (eta_metal>1e-2 & eta_oxide>1e-2, L1, if(eta_metal>1e-2 & eta_gas>1e-2, L3, if(eta_oxide>1e-2 & eta_gas>1e-2, L2, L_bulk)))'
