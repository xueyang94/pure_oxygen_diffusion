#don't use grand potential kernel action, write my own input file, based on Larry's input file for multiphase
#purpose of this is to be able to define different mobilities for different order parameters through defining different phase mobilities, cuz in action, I can't do that
#I want to control oxide growing into the metal, not the gas by controlling the phase mobility
#unit of lengh is nm
...
[./constants]
  ...
  prop_values = '1.5    1.5     1.5     13.8  1e7   1e-4      0.5       1      3.2     3.2     3.2    10                   10                    1e7                  1e4                 1e4'
[../]
[./m]
  type = ParsedMaterial
  f_name = mu
