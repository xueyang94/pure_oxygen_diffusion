#model Fe atom as the diffusion species, oxide growth occur at the FeO-O2 interface
#study how phase mobility can affect the interface evolution
#change L to an 'if' function, found that if L1, L2, L3 are different, not converging
#unit of lengh is nm
[Mesh]
  type = GeneratedMesh
  dim = 2
...
[./ACgas_sw]
  ...
  Fj_names = 'omega_metal omega_oxide omega_gas'
  hj_names = 'switch_metal switch_oxide switch_gas'
  args = 'eta_metal eta_oxide mu_Fe'
  mob_name = L
[../]
[./ACgas_int]
  type = ACInterface
...
[./constants]
  ...
  prop_values = '1.5    1.5     1.5     13.8  1e7    1      0.5       1e-4      3.2     3.2     3.2    10                   10                      1e4                  1e4                 1e4'
[../]
[./m]
  type = ParsedMaterial
  f_name = mu
...
[./L]
  ...
  function = 'if (eta_metal>1e-4 & eta_oxide>1e-4, L1, if(eta_metal>1e-4 & eta_gas>1e-4, L2, if(eta_oxide>1e-4 & eta_gas>1e-4, L3, L1)))'
[../]
...
[./omega_metal]
  ...
  function = '-0.5*mu_Fe^2/Va^2/k_metal - cmetal_eq*mu_Fe/Va'
  derivative_order = 2
[../]
[./omega_oxide]
  type = DerivativeParsedMaterial
  ...
  function = '-0.5*mu_Fe^2/Va^2/k_oxide - coxide_eq*mu_Fe/Va'
  derivative_order = 2
[../]
[./omega_gas]
  type = DerivativeParsedMaterial
  ...
  function = '-0.5*mu_Fe^2/Va^2/k_gas - cgas_eq*mu_Fe/Va'
  derivative_order = 2
[../]
[./rho_metal]
  type = DerivativeParsedMaterial
  ...
  args = mu_Fe
  material_property_names = 'Va k_metal cmetal_eq'
  function = 'mu_Fe/Va^2/k_metal + cmetal_eq/Va'
  derivative_order = 1
[../]
[./rho_oxide]
  type = DerivativeParsedMaterial
  ...
  args = mu_Fe
  material_property_names = 'Va k_oxide coxide_eq'
  function = 'mu_Fe/Va^2/k_oxide + coxide_eq/Va'
  derivative_order = 1
[../]
[./rho_gas]
  type = DerivativeParsedMaterial
  ...
  args = mu_Fe
  material_property_names = 'Va k_gas cgas_eq'
  function = 'mu_Fe/Va^2/k_gas + cgas_eq/Va'
  derivative_order = 1
[../]
[]
