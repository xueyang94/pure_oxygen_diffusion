#modify Chai's smooth square function. See MATLAB script named smooth_wave_function regarding how this function is derived. (u is how long the function was shifted along x axis)
#unit of lengh is nm
[Mesh]
  type = GeneratedMesh
  dim = 2
...
[./constants]
  ...
  prop_values = '1.5    1.5     1.5     13.8  1e6   1e-4      0.5       1      3.2     3.2     3.2   10                   10                      0.4e4           0.3e4                  0.5e4                  0.6e4 0.15 3.1416 0.001'
[../]
[./m]
  type = ParsedMaterial
  f_name = mu
...
[./L_switch_metal]
  ...
  function = '1/pi*atan(sin(1/(1 - 2*u)*pi*(eta_metal - u))/delta) + 1/2'
[../]
[./L_switch_oxide]
  type = ParsedMaterial
  ...
  args = 'eta_oxide'
  material_property_names = 'u pi delta'
  function = '1/pi*atan(sin(1/(1 - 2*u)*pi*(eta_oxide - u))/delta) + 1/2'
[../]
[./L_switch_gas]
  type = ParsedMaterial
  f_name = L_switch_gas
  args = 'eta_gas'
  material_property_names = 'u pi delta'
  function = '1/pi*atan(sin(1/(1 - 2*u)*pi*(eta_gas - u))/delta) + 1/2'
[../]
