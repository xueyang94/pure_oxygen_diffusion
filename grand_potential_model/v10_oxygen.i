...
#change mobility L to a linear function of order parameters
...
[./constants]
  ...
  prop_values = '1.5    1.5     1.5     13.8  1e7   1e-4      0.5       1      3.2     3.2     3.2    10                   10                     1e5                 1e4                  1e3'
[../]
[./m]
  type = ParsedMaterial
  f_name = mu
...
[./L]
  ...
  function = '(L1*eta_metal + L2*eta_oxide + L3*eta_gas)/(eta_metal + eta_oxide + eta_gas)'
  #outputs = exodus
[../]
[./view_L]
  type = ParsedMaterial
