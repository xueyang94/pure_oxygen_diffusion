#try to change chemical potential diffusivity D to a function of order parameters, or using the intropolation function in M
#unit of lengh is nm
[Mesh]
  type = GeneratedMesh
  dim = 2
...
[./constants]
  ...
  prop_names = 'g_metal g_oxide g_gas   Va       cmetal_eq coxide_eq cgas_eq k_metal k_oxide k_gas interface_energy_sigma interface_thickness_l phase_mobility_metal phase_mobility_oxide phase_mobility_gas D_metal D_oxide D_gas'
  prop_values = '1.5    1.5     1.5     13.8     1e-4      0.5       1      3.2     3.2     3.2    10                   10                      1e4                  1e4                  1e4                1e6    1e7    1e7'
[../]
[./m]
  type = ParsedMaterial
  f_name = mu
...
[./L]
  ...
  f_name = L
  args = 'eta_metal eta_oxide eta_gas'
  material_property_names = 'L1 L2 L3'
  ...
  function = 'if (eta_metal>0 & eta_oxide>0, L1, if(eta_metal>0 & eta_gas>0, L2, if(eta_oxide>0 & eta_gas>0, L3, L1)))'
[../]
...
#   f_name = D
#   args = 'eta_metal eta_oxide eta_gas'
#   material_property_names = 'D_metal D_oxide D_gas'
#   function = '(D_metal*eta_metal*eta_metal + D_oxide*eta_oxide*eta_oxide + D_gas*eta_gas*eta_gas)/(eta_metal*eta_metal + eta_oxide*eta_oxide + eta_gas*eta_gas)'
# [../]
...
[./mobility]
  type = DerivativeParsedMaterial
  f_name = M_o
  material_property_names = 'switch_metal switch_oxide switch_gas k_metal k_oxide k_gas D_metal D_oxide D_gas Va'
  function = '(switch_metal*D_metal/k_metal + switch_oxide*D_oxide/k_oxide + switch_gas*D_gas/k_gas)/Va/Va'
  derivative_order = 2
[../]
