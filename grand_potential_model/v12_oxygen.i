...
[./constants]
  ...
  prop_values = '1.5    1.5     1.5     13.8  1e6   1e-4      0.5       1      3.2     3.2     3.2    10                   10                    1e4           1e5                 1e4                   1e3'
[../]
[./m]
  type = ParsedMaterial
  f_name = mu
...
[./part1]
  ...
  f_name = part1
  args = 'eta_metal eta_oxide eta_gas'
  material_property_names = 'L12 L_bulk switch_12'
  function = 'switch_12*((L12 + L_bulk)/2 + (L12 - L_bulk)/3.14*atan(sin(2*3.14*(eta_metal-0.25))/0.01))'
[../]
[./part2]
  type = ParsedMaterial
  f_name = part2
  args = 'eta_oxide'
  material_property_names = 'L23 L_bulk switch_23'
  function = 'switch_23*((L23 + L_bulk)/2 + (L23 - L_bulk)/3.14*atan(sin(2*3.14*(eta_oxide-0.25))/0.01))'
[../]
[./part3]
  type = ParsedMaterial
  f_name = part3
  args = 'eta_gas'
  material_property_names = 'L13 L_bulk switch_13'
  function = 'switch_13*((L13 + L_bulk)/2 + (L13 - L_bulk)/3.14*atan(sin(2*3.14*(eta_gas-0.25))/0.01))'
[../]
