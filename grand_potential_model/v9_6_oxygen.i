...
[./constants]
  ...
  prop_values = '1.5    1.5     1.5     13.8     1e-4      0.5       1      3.2     3.2     3.2    10                   10                      1e3                  1e4                  1e5                1e3    1e4    1e5'
[../]
[./m]
  type = ParsedMaterial
  f_name = mu
...
[./L]
  ...
  f_name = L
  args = 'eta_metal eta_oxide eta_gas'
  material_property_names = 'L1 L2 L3 switch_metal switch_oxide switch_gas'
  function = 'eta_metal^2*eta_oxide^2*L1 + eta_oxide^2*eta_gas^2*L2 + eta_metal^2*eta_gas^2*L3 + L2'
  outputs = exodus
[../]
...
[./mobility]
  type = DerivativeParsedMaterial
  f_name = M_o
  material_property_names = 'switch_metal switch_oxide switch_gas Va k_metal k_oxide k_gas D_metal D_oxide D_gas'
  function = '(switch_metal*D_metal/k_metal + switch_oxide*D_oxide/k_oxide + switch_gas*D_gas/k_gas)/Va^2'
  derivative_order = 2
  outputs = exodus
[../]
