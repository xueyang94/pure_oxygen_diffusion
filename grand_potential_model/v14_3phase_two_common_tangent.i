...
#make oxygen phase free energy have the same common tangent line as the other two phases, and tangent point (1, -2.45). So the system is at eutectic temperature with zero degree of freedom
...
[Mesh]
  ...
  nx = 400
  xmin = 0
  xmax = 400 #notice that is different from before, because I want to avoid the average chemical potential IC being an infinite floating point
  ny = 1
  ymin = 0
  ymax = 100
[]
...
[ICs]
  [./IC_mu_o]
    type = FunctionIC
    variable = mu_o
    function = '0' #c = 0.765625
  [../]
  # [./IC_mu]
  #   type = MultiBoundingBoxIC
  #   variable = mu_o
  #   inside = '-24.84 -69 0'
  #   corners = '-3 -3 0 100 -3 0 130 -3 0'
  #   opposite_corners = '100 103 0 130 103 0 303 103 0'
  # [../]
  [./IC_eta_metal]
    type = BoundingBoxIC
    variable = eta_metal
...
[./constants]
  ...
  prop_names = 'g_metal g_oxide g_gas   Va     D  cmetal_eq coxide_eq cgas_eq k_metal k_oxide k_gas  interface_energy_sigma interface_thickness_l bulk_mobility phase_mobility_12 phase_mobility_23 phase_mobility_13 u    pi     delta L'
  prop_values = '1.5    1.5     1.5     13.8  1e8  0.28125  0.78125    1       6.4     6.4    6.4              10                   10                 0.4e4           0.3e4            0.5e4             0.6e4      0.07 3.1416 0.0001 1e5'
[../]
[./m]
  type = ParsedMaterial
  f_name = mu
...
[./omega_gas]
  ...
  function = '-0.5*mu_o^2/Va^2/k_gas - cgas_eq*mu_o/Va - 2'
  derivative_order = 2
[../]
[./rho_metal]
  type = DerivativeParsedMaterial
