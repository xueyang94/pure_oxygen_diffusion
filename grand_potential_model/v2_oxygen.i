#unit of lengh is nm
#use FeO-O and Fe-O systems free energy data from paper "Thermodynamic re-evaluation of the Fe-O systems" to get the parabolic coeff, and assume equal parabolic coeff and assign values of equilibrium concentration of O in each phases
[Mesh]
  type = GeneratedMesh
  dim = 2
  nx = 100
