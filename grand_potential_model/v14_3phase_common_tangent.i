...
[ICs]
  [./IC_mu_o]
    type = FunctionIC
    variable = mu_o
    #function = 'if(x<100, -24.84, if(x<130, -69, 0))'
    #function = 'if(x<100, -4.416e-3, if(x<130, -22.08, 0))'
    function = '-24.84' #this is the common tangent slope times Va. It is the equilibrium situation, meaning that nothing is changing
  [../]
  # [./IC_mu]
...
[./constants]
  ...
  prop_values = '1.5    1.5     1.5     13.8  1e8  0.28125  0.78125   1.28125   6.4     6.4    6.4   10                   10                      0.4e4           0.3e4                  0.5e4             0.6e4      0.07 3.1416 0.0001'
[../]
[./m]
  type = ParsedMaterial
  f_name = mu
...
[./omega_gas]
  ...
  function = '-0.5*mu_o^2/Va^2/k_gas - cgas_eq*mu_o/Va - 2.703125'
  derivative_order = 2
[../]
[./rho_metal]
  type = DerivativeParsedMaterial
