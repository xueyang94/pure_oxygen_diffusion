...
#change mobility L to an unlinear and hopefully smooth function of the order parameters
...
[./constants]
  ...
  prop_values = '1.5    1.5     1.5     13.8  1e8   1e-4      0.5       1      3.2     3.2     3.2    10                   10                     1e5                 1e4                  1e3'
[../]
[./m]
  type = ParsedMaterial
  f_name = mu
...
[./L]
  ...
  function = 'eta_metal^3*eta_oxide^3*L1 + eta_oxide^3*eta_gas^3*L2 + eta_metal^3*eta_gas^3*L3 + L3'
  #outputs = exodus
[../]
[./view_L]
  type = ParsedMaterial
