#make the three phase mobilities be the same, to compare with Ian's kernel action simulation. Compare result and performance time
#unit of lengh is nm
#change the switching function from Larry's input file to the same as v3_oxygen: SwitchingFunctionMaterial, to strictly compare with v3_oxygen kernel action
[Mesh]
  type = GeneratedMesh
  dim = 2
  nx = 100
...
[./constants]
  ...
  prop_values = '1.5    1.5     1.5     13.8  1e7   1e-4      0.5       1      3.2     3.2     3.2    10                   10                    1e4                  1e4                 1e4'
[../]
[./m]
  type = ParsedMaterial
  f_name = mu
