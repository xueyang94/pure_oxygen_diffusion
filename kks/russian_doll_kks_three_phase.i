...
[ICs]
  [./c]
    ...
    variable = c
    lower_left_corners = '200 50 0 150 30 0 100 20 0'
    upper_right_corners = '210 60 0 280 80 0 300 90 0'
    inside = '0.2 0.5 0.8'
    outside = 1
    int_width = 5
  [../]
  # [./c]
  #   type = RandomBoundingBoxIC
  #   variable = c
  #   lower_left_corners = '-5 -5 0 -5 -5 0 -5 -5 0'
  #   upper_right_corners = '100 105 0 200 105 0 405 105 0'
  #   inside = '0.2 0.5 0.8'
  #   outside = '0.5 0.8 0'
  #   int_width = 10
  # [../]
  ...
  #   type = RandomBoundingBoxIC
  #   variable = c
  #   lower_left_corners = '20 20 0 200 40 0 170 30 0'
  #   upper_right_corners = '50 30 0 220 50 0 250 70 0'
  #   inside = '0.2 0.5 0.8 '
  #   outside = '0 3 0'
  #   int_width = 5
  # [../]
  # [./c] #gives partially overlapping error
  #   type = IsolatedBoundingBoxIC
  #   variable = c
  #   lower_left_corners = '100 20 0 130 25 0 350 40 0'
  #   upper_right_corners = '150 30 0 300 80 0 360 70 0'
  #   inside = '0.2 0.5 0.8 '
  #   outside = 1
  #   int_width = 5
  # [../]
  ...
  #   type = IsolatedBoundingBoxIC
  #   variable = c
  #   lower_left_corners = '20 20 20 170 50 80 320 250 170'
  #   upper_right_corners = '150 30 30 300 80 120 380 320 380'
  #   inside = '0.2 0.5 0.8 '
  #   outside = 1
  #   int_width = 5
  # [../]
...
[Executioner]
  ...
  [Adaptivity]
    ...
    refine_fraction = 0.9 # Fraction of high error that will be refined
